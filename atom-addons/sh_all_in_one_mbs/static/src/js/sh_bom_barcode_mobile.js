$(document).ready(function () {
    ...
    codeReader
        ...
        .then(function (result) {
            ...
            //const sourceSelect = $("#js_id_sh_bom_barcode_mobile_cam_select");
             ...
             * =============================
             */        
        	$(document).on('change', '#js_id_sh_bom_barcode_mobile_cam_select', function(ev) {
        		...
        		$("#js_id_sh_bom_barcode_mobile_reset_btn").click();
        		$("#js_id_sh_bom_barcode_mobile_start_btn").click();
             ...
             * ========================
             */
            $(document).on("click", "#js_id_sh_bom_barcode_mobile_start_btn", function (event) {
                //EMPTY INPUT
                $('input[name="sh_bom_barcode_mobile"]').val("");
                $('input[name="sh_bom_barcode_mobile"]').change();

                //SHOW VIDEO
                $("#js_id_sh_bom_barcode_mobile_vid_div").show();

                //SHOW STOP BUTTON
                $("#js_id_sh_bom_barcode_mobile_reset_btn").show();

                //CALL METHOD
                //CONTINUOUS SCAN OR NOT.
                if ($('span[name="sh_bom_bm_is_cont_scan"]').text() == "True") {
             ...
             * =============================
             */
            $(document).on("click", "#js_id_sh_bom_barcode_mobile_reset_btn", function () {

                document.getElementById("js_id_sh_bom_barcode_mobile_result").textContent = "";
